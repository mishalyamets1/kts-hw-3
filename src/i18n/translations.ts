...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'auth.error.userExists': 'User with this email already exists',
    ...
    'menu.priceMax': 'Max',
    'menu.sort': 'Sort',
    'menu.sortAscending': 'Sort ↑',
    'menu.sortDescending': 'Sort ↓',
    ...
    'checkout.shippingAddressPlaceholder': 'Rubtsovskaya naberzhnaya 3/1, Moscow',
  ...
  ru: {
    ...
    'menu.priceRange': 'Диапазон цены',
    'menu.priceMin': 'От',
    'menu.priceMax': 'До',
    'menu.sort': 'Сортировка',
    'menu.sortAscending': 'Сортировка ↑',
    'menu.sortDescending': 'Сортировка ↓',
    ...
    'checkout.shippingAddressPlaceholder': 'Рубцовская наб., 3с1., Москва',
