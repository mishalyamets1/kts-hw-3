...
const Loader: React.FC<LoaderProps> = ({size = 'l', className}) => {
    ...
    return <svg xmlns="http://www.w3.org/2000/svg" width={pixelSize} height={pixelSize} viewBox="0 0 60 60" fill="none" color='var(--brand)'  className={className} style={{'--brand': '#518581'} as React.CSSProperties}>
